 ...
 * TODO : DOC
 */
export function oraTask ( taskOptions:Partial<IOraTaskOptions>|string, handler:(taskUpdater?:ITaskUpdater) => any|void, onError?:(e:Error, taskUpdater:ITaskUpdater) => void ) {
